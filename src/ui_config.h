...
**
** Created: Fri Jun 8 11:32:58 2012
...
public:
    ...
    void setupUi(QWidget *Config)
    {
        ...
        spinCoefExt1->setSingleStep(0.1);
        spinCoefExt1->setValue(1);
        ...
        spinCoefExt2->setSingleStep(0.1);
        spinCoefExt2->setValue(1);
        spinCoefExt3 = new QDoubleSpinBox(frame_3);
        spinCoefExt3->setObjectName(QString::fromUtf8("spinCoefExt3"));
        spinCoefExt3->setGeometry(QRect(141, 131, 63, 20));
        spinCoefExt3->setMinimum(-100);
        spinCoefExt3->setMaximum(100);
        spinCoefExt3->setSingleStep(0.1);
        spinCoefExt3->setValue(1);
        ...
        spinCoefRef3->setSingleStep(0.1);
        spinCoefRef3->setValue(1);
        ...
        spinCoefRef2->setSingleStep(0.1);
        spinCoefRef2->setValue(1);
        ...
        spinCoefRef1->setSingleStep(0.1);
        spinCoefRef1->setValue(1);
    ...
    void retranslateUi(QWidget *Config)
    {
        ...
        labelLien->setText(QApplication::translate("Config", "/home", 0, QApplication::UnicodeUTF8));
